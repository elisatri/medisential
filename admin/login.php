...
<head>
  ...
  <title>Login Admin : Medisential</title>
  <!-- BOOTSTRAP STYLES-->
  ...
  <div class="container">
    <div class="row text-center">
      <div class="col-md-12">
        ...
        <h5>( Login with your access to admin Medisential )</h5>
        <br />
      </div>
    </div>
    <div class="row ">
      ...
      <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
        ...
        <a href="../login.php" class="blue-text text-darken-2">Login sebagai Customer</a>
    </div>
